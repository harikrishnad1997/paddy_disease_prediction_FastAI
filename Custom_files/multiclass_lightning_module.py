...
class MultiClassLightningModule(pl.LightningModule):
    def __init__(self, model, optimizer_cls, loss_fn, metric_cls, num_classes, learning_rate, log_every_n_steps=50, 
                 log_test_metrics=True, display_metrics=True, optimizer_params=None):
        super().__init__()
